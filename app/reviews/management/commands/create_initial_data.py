"""
Django command create initial data.
"""
import random
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        books = [
            (
                'Life of John',
                'A biography of John West. This book delves deep into his life and accomplishments, highlighting his significant contributions to literature and society.',
                'Biography',
                'John West',
            ),
            (
                'The Future',
                'A science fiction novel by Jane Doe. Set in a dystopian future, it explores themes of technology and humanity.',
                'Science Fiction',
                'Jane Doe',
            ),
            (
                'Magic World',
                'A fantasy novel by Alice Smith. It tells the story of a young hero in a land filled with magic and mystery.',
                'Fantasy',
                'Alice Smith',
            ),
            (
                'Mystery Mansion',
                'A thrilling mystery by Robert Brown. Follow the detective as they uncover secrets hidden in the old mansion.',
                'Mystery',
                'Robert Brown',
            ),
            (
                'Love Story',
                'A romance novel by Emily White. This heartwarming tale explores the journey of love and relationships.',
                'Romance',
                'Emily White',
            ),
            (
                'True Stories',
                'A collection of non-fiction stories by Michael Green. These real-life accounts are both inspiring and educational.',
                'Non-Fiction',
                'Michael Green',
            ),
            (
                'Teen Tales',
                'Young adult stories by Laura Black. These tales capture the essence of teenage life and its challenges.',
                'Young Adult',
                'Laura Black',
            ),
            (
                'Historic Times',
                'Historical fiction by Chris Red. Set in ancient times, this book brings history to life through engaging narratives.',
                'Historical',
                'Chris Red',
            ),
            (
                'Children Adventures',
                'Children’s books by Nina Blue. These stories are filled with adventure and valuable life lessons for kids.',
                'Children',
                'Nina Blue',
            ),
            (
                'Epic Journeys',
                'Adventure stories by Oliver Grey. Embark on epic journeys through unknown lands and face thrilling challenges.',
                'Adventure',
                'Oliver Grey',
            ),
            (
                'Scary Nights',
                'A horror book by Chris Red. Experience spine-chilling tales that will keep you up at night.',
                'Horror',
                'Chris Red',
            ),
            (
                'Mindful Living',
                'Self-help book by Laura Black. Learn about mindfulness and living a balanced life through practical advice.',
                'Self-Help',
                'Laura Black',
            ),
            (
                'Around the World',
                'Travel stories by Michael Green. Discover the wonders of the world through the eyes of the author.',
                'Travel',
                'Michael Green',
            ),
            (
                'Gourmet Cooking',
                'A cookbook by Emily White. Explore gourmet recipes and culinary techniques from around the globe.',
                'Cooking',
                'Emily White',
            ),
            (
                'Fantastic Futures',
                'More science fiction by Jane Doe. Dive into futuristic worlds with innovative technology and complex characters.',
                'Science Fiction',
                'Jane Doe',
            ),
        ]
        for title, description, category_name, author_name in books:
            if not Book.objects.filter(title=title).exists():
                ...
                Book.objects.create(title=title, description=description, category=category, author=author)
